      ...
      <div className="ResearchContainer">
        ...
        <ul className="notes-list">
          <li>
            ...
            <span className="note-authors"> by Simran Arora, Sabri Eyuboglu, and Chris Ré, 2024.</span>
          </li>
          <li>
            <a href="https://hazyresearch.stanford.edu/blog/2024-05-12-tk">
              GPUs Go Brrr
            </a>
            <span className="note-authors"> by Benjamin Spector, Aaryan Singhal, Simran Arora, and Chris Ré, 2024.</span>
          </li>
          <li>
            <a href="https://hazyresearch.stanford.edu/blog/2023-06-08-hyena-safari">
              The Safari of Deep Signal Processing: Hyena and Beyond
            </a>
            <span className="note-authors"> by Michael Poli, Stefano Massaroli, Simran Arora, Dan Fu, Stefano Ermon, Chris Ré, 2023.</span>
          </li>
          <li>
            ...
            <span className="note-authors"> with Michael Wornow, Nandita Bhaskar, and Percy Liang, 2023.</span>
          </li>
          <li>
            ...
            <span className="note-authors"> with Principle Authors: Daniel E. Ho, Jennifer King, Russell C. Wald, Christopher Wan. We wrote an HAI White Paper in October, 2022. Section §5 Data Privacy Compliance by S. Arora, N. Guha, J. King, S. Suri, C. Wan, S. Wiltshire.</span>
          </li>
          <li>
            <a href="https://arxiv.org/abs/2108.07258">
              On the Opportunities and Risks of Foundation Models
            </a>
            <span className="note-authors"> with Principle Authors: Rishi Bommasani and Percy Liang. Data Section by L. Orr, S. Arora, K. Goel, A. Narayan, M. Zhang, C. Ré., 2021.</span>
          </li>
          <li>
            ...
            <span className="note-authors"> with Chris Ré, 2023.</span>
          </li>
          <li>
            ...
            <span className="note-authors"> with Chris Ré, 2022.</span>
          </li>
          <li>
            <a href="https://hazyresearch.stanford.edu/what-data-centric-ai-is-not">
              What Data Centric AI is Not
            </a>
            <span className="note-authors"> with Chris Ré, 2021.</span>
          </li>
        </ul>
      </div>
    );
