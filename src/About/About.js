    ...
    <div className="about-container">
      <div className="about-left">
        ...
        <div className="contact-info">
          <a href="mailto:simarora@caltech.edu" className="email-link">
            simarora@caltech.edu
          </a>
      ...
      <div className="about-right">
        ...
        <div className="about-text">
            Hi, I'm Simran. I'm am an incoming assistant professor at <a class="abt_a" target= "_blank" rel="noopener noreferrer" href="https://www.cms.caltech.edu/">Caltech Computing + Mathematical Sciences</a>  and lead the Frontier Performance research team at <a class="abt_a" target= "_blank" rel="noopener noreferrer" href="https://www.together.ai/">Together AI</a> (hiring for both!).
            I am also an advisor to <a class="abt_a" target= "_blank" rel="noopener noreferrer" href="https://cartesia.ai/">Cartesia</a> and <a class="abt_a" target= "_blank" rel="noopener noreferrer" href="https://engram.com/">Engram</a>. <br/><br/>
